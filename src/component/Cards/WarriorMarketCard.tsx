	...
	return (
		<Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
			<Card sx={{ position: 'relative' }}>
				...
				<Box sx={{ display: 'flex', position: 'absolute', alignItems: 'center', bottom: '10px', left: 'calc(50% - 40px)', fontWeight: 'bold' }}>
					<Typography variant='h6' sx={{ fontWeight: 'bold', fontSize: '1.4rem', textShadow: '-2px -2px 0 #000,2px -2px 0 #000,-2px 2px 0 #000,2px 2px 0 #000' }}>{formatNumber(power)} AP</Typography>
				</Box>
				{
					owner === true &&
